...
export default function CreateAccount() {
  ...
  return (
    <div>
      ...
      <InputBox textValueEmail={textValueEmail} textValuePassword={textValuePassword} textValueFullName={textValueFullName} name="Full Name" placeholder="Full Name" onChange={(text) => {
        handleChange(text, "name")
      }} />
      <InputBox textValueEmail={textValueEmail} textValuePassword={textValuePassword} textValueFullName={textValueFullName} name="Email" placeholder="Email" onChange={(text) => {
        handleChange(text, "email")
      }} />
      <InputBox textValueEmail={textValueEmail} textValuePassword={textValuePassword} textValueFullName={textValueFullName} name="Password" placeholder="Password" onChange={(text) => {
