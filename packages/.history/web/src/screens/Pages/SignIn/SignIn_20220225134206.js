...
export default function SignIn() {
  ...
  const [emailValidation, setEmailValidation] = (false);
  const [PasswordValidation, setPasswordValidation] = (false);
  ...
  console.log(textValueEmail)
  return (
    <div>
      <InputBox name="Email" textValueEmail={textValueEmail} placeholder="Email" onChange={(text) => {
        handleChange(text, "email")
      }} />
      <InputBox name="Password" textValuePassword={textValuePassword} placeholder="Enter your password" onChange={(text) => {
