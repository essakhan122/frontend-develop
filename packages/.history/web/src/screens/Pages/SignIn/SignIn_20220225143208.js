...
export default function SignIn() {
  ...
  return (
    <div>
      <InputBox textValuePassword={textValuePassword} emailValidation={emailValidation} name="Email" textValueEmail={textValueEmail} placeholder="Email" onChange={(text) => {
        handleChange(text, "email")
      }} />
      <InputBox name="Password" textValueEmail={textValueEmail} passwordValidation={PasswordValidation} textValuePassword={textValuePassword} placeholder="Enter your password" onChange={(text) => {
