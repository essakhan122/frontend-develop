...
export default function SignIn() {
  ...
  return (
    <div>
      <InputBox textValuePassword={textValuePassword} name="Email" textValueEmail={textValueEmail} placeholder="Email" onChange={(text) => {
        handleChange(text, "email")
      }} />
      <InputBox name="Password" textValueEmail={textValueEmail} textValuePassword={textValuePassword} placeholder="Enter your password" onChange={(text) => {
