...
export default function SignIn() {
  ...
  console.log(textValuePassword)

  return (
    <div>
      <InputBox textValueEmail={textValueEmail} type="email" name="Email" placeholder="Email" onChange={(text) => {
        handleChange(text, "email")
      }} />
      <InputBox name="Password" textValuePassword={textValuePassword} type="password" placeholder="Enter your password" onChange={(text) => {
